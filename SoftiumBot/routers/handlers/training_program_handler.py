...
programs = {
    "Базовая компьютерная грамотность":
        ...
        "📄 Узнайте подробности о программе здесь [ссылка на презу этой программы]\n"
    ...
    "Компьютерная графика и web-дизайн":
        ...
        "📄 Смотреть презентацию программы [ссылка на презу этой программы]\n"
    ...
    "Разработка приложений и программирование на Python":
        ...
        "📄 Подробнее о программе — в презентации [ссылка на презу этой программы]\n"
    ...
    "Создание игр":
        ...
        "📄 Ознакомьтесь с программой в презентации [ссылка на презу этой программы]\n"
